...
import { Code2, Smartphone, Cloud, Database, Brain, Building2, Zap, TrendingDown } from "lucide-react"
    ...
    <section id="services" className="px-6 py-24 bg-white">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/* Service 7 - Serverless & Cost Optimization */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            ...
            <Card className="group h-full overflow-hidden border-slate-200 bg-white hover:border-blue-300 hover:shadow-lg transition-all duration-300 rounded-2xl">
              <CardContent className="p-6 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  >
                    <Zap className="w-5 h-5 text-blue-600 group-hover:text-blue-700 transition-colors" />
                  </motion.div>
                  <p className="font-heading font-semibold text-slate-900">Serverless & Optimization</p>
                </div>
                <p className="text-slate-600 text-sm mb-4">
                  Build serverless applications with AWS Lambda, Firebase, and Vercel. Eliminate infrastructure overhead and scale automatically.
                </p>
                <div className="mt-auto">
                  <p className="text-xs text-slate-500">Lambda • Vercel • Firebase • API Gateway</p>
                </div>
              </CardContent>
            </Card>
          </motion.div>

          {/* Service 8 - Cost Reduction & Performance Tuning */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            ...
            <Card className="group h-full overflow-hidden border-slate-200 bg-white hover:border-blue-300 hover:shadow-lg transition-all duration-300 rounded-2xl">
              <CardContent className="p-6 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  >
                    <TrendingDown className="w-5 h-5 text-blue-600 group-hover:text-blue-700 transition-colors" />
                  </motion.div>
                  <p className="font-heading font-semibold text-slate-900">Cost Reduction & Optimization</p>
                </div>
                <p className="text-slate-600 text-sm mb-4">
                  Audit and optimize your infrastructure costs. Database performance tuning, caching strategies, and resource optimization.
                </p>
                <div className="mt-auto">
                  <p className="text-xs text-slate-500">Cost Analysis • Performance Tuning • Caching</p>
                </div>
              </CardContent>
            </Card>
          </motion.div>
